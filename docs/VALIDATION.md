...
- Local end-to-end HTTPS boundary simulation: the Sites route proxies account requests to the Node service, the service rejects requests without its shared secret, same-origin requests reach PostgreSQL and cross-origin writes are rejected.
